...
with st.expander("🧮 Model Information"):
    st.markdown("""
    1. The feed pressurisation step was set at a fixed time of 20 seconds.
    2. Zeolite 13X isotherm parameters were taken R. Haghpanah et al's paper [1].
    3. VPSA cycle theory based on standard adsorption engineering principles.
    4. Neural network with Monte Carlo dropout for uncertainty estimation.
    5. Uncertainty estimation performed by running multiple forward passes through the network with dropout enabled.
    """)
