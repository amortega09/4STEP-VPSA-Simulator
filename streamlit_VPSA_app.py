...
with st.expander("🧮 Model Information"):
    ...
    3. The model was trained on data produced through a mathematical model. 
    4. The neural network was built in Pytorch with Monte Carlo dropout used foruncertainty estimation.
    """)
